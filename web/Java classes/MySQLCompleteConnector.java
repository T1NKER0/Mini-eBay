...
public class MySQLCompleteConnector{
	...
	private String DB_URL="jdbc:mysql://localhost/mini_ebay_cpen410";
	...
	*/
	public boolean doInsert(String table, String values)
	{
		...
		try{
			...
			//perform the query and catch results
	...
	/***********
		doDelete method
			This method performs a delete to the database
			@parameters:
				table: selected table 
				where: value to be deleted
				
			@returns:
				boolean value: true: the delete was ok, an error was generated
	*/
	public boolean doDelete(String table, String where) {
		...
		//try to delete a record to the selected table
		try {
