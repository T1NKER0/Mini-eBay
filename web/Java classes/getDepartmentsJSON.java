...
public class getDepartmentsJSON extends HttpServlet {
   ...
   */
   ...
   public JSONArray createJSonArray()
   {
	   ...
	   //Connect the the database
		...
		try{
			//query the database
		   ResultSet res= appDBMg.listAllDepartments();
			System.out.println("Departments Listed...");
   ...
   */ 
   public JSONObject createJSon(ResultSet res)
   {
	   ...
	   try{
			...
			json.put("Department Name", res.getString(1));
	} catch(Exception e)
	   {
		   e.printStackTrace();
	   }
